...
#connections(
  ...
  [#link("https://github.com/jitendra", icon: false, if-underline: false, if-color: false)[github.com\/jitendra]],
)


== Summary

Qualified Cost and Management Accountant (CMA) and MBA graduate with practical experience in Statutory Audits, Internal Audits, and Taxation (GST\/ITR). Upcoming SAP Certified Application Associate (C\_TS4FI) with strong foundational knowledge in SAP FICO (GL, AP\/AR). Seeking a challenging role in Financial Management or SAP Consulting.
...
#regular-entry(
  [
    #strong[Salesforce Administrator Intern]

    #emph[Salesforce (Virtual)]

  ],
  [
    #emph[Remote]

    #emph[Aug 2022 – Oct 2022]
...
#regular-entry(
  ...
  main-column-second-row: [
    - #strong[Fundamentals of Cost Accounting:] 86\% (Top 2\% Score)

    - #strong[Introduction to GST:] 57\%
